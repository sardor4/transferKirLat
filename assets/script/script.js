    ...
    if (transfer1.getAttribute('id') == 'kirill') {
        ...
        $(document).ready(function(){
            $("#lotin").keyup(function(){
                var lotinText = $(this).val().replaceAll('Ya','Я').replaceAll('YA','Я').replaceAll('ya','я').replaceAll('Sh','Ш').replaceAll('SH','Ш').replaceAll('sh','ш').replaceAll('A','А').replaceAll('a','а').replaceAll('b','б').replaceAll('B','Б').replaceAll('V','В').replaceAll('v','в').replaceAll('G’','Ғ').replaceAll('g’','ғ').replaceAll('G','Г').replaceAll('g','г').replaceAll('D','Д').replaceAll('d','д').replaceAll('EY','Е').replaceAll('ye','е').replaceAll('CH','Ч').replaceAll('Ch','Ч').replaceAll('ch','ч').replaceAll('Yo','Ё').replaceAll('YO','Ё').replaceAll('yo','ё').replaceAll('J','Ж').replaceAll('j','ж').replaceAll('Z','з').replaceAll('z','з').replaceAll('I','И').replaceAll('i','и').replaceAll('Y','Й').replaceAll('y','й').replaceAll('k','к').replaceAll('K','К').replaceAll('L','Л').replaceAll('l','л').replaceAll('M','М').replaceAll('m','м').replaceAll('N','Н').replaceAll('n','н').replaceAll('o’','ў').replaceAll('O’','Ў').replaceAll('o','о').replaceAll('O','О').replaceAll('P','П').replaceAll('p','п').replaceAll('R','Р').replaceAll('r','р').replaceAll('S','С').replaceAll('s','с').replaceAll('T','Т').replaceAll('t','т').replaceAll('U','У').replaceAll('u','у').replaceAll('F','Ф').replaceAll('f','ф').replaceAll('X','Х').replaceAll('x','х').replaceAll('`','ъ').replaceAll(`'`,'ъ').replaceAll('Yu','Ю').replaceAll('YU','Ю').replaceAll('yu','ю').replaceAll('W','В').replaceAll('w','в').replaceAll('Q','Қ').replaceAll('q','қ').replaceAll('h','ҳ').replaceAll('H','Ҳ');
